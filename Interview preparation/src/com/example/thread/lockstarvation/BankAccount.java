...
public class BankAccount {
	...
	public static void main(String[] args) {
		...
		Thread balanceMonitorThread1 = new Thread(
				new BalanceMonitor(fooAccount), "BalanceMonitor");
		Thread transactionThread1 = new Thread(new Transaction(fooAccount,
				barAccount, 250d), "Transaction-1");
		Thread transactionThread2 = new Thread(new Transaction(fooAccount,
				barAccount, 250d), "Transaction-2");
...
class BalanceMonitor implements Runnable {
	...
	public void run() {
		...
		System.out.format(
				"%s : account has gone too low, email sent, exiting.", Thread
