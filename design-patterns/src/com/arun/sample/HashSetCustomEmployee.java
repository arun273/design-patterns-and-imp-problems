...
/**
 * Person class- to be used as key in HashSetCustom.
 */
class Person {
	private String id;
	private String name;
	 ...
	 */
	public Person(String id, String name) { // constructor
		this.id = id;
		this.name = name;
	}
...
public class HashSetCustomEmployee {
	...
	public static void main(String[] args) {
		...
		HashSetCustom<Person> hashSetCustom = new HashSetCustom<Person>();
		hashSetCustom.add(new Person("10", "sam"));
		hashSetCustom.add(new Person("21", "amy"));
		hashSetCustom.add(new Person("31", "rob"));
		hashSetCustom.add(new Person("41", "sam"));
		hashSetCustom.add(new Person("42", "wil"));

		System.out.println("HashSetCustom contains employee with id=21 & name='amy' : "
				+ hashSetCustom.contains(new Person("21", "amy")));
		System.out.println("HashSetCustom contains employee with id=51 & name='pat' : "
				+ hashSetCustom.contains(new Person("51", "pat")));

		System.out.print("Displaying : ");
		hashSetCustom.display();

		System.out.println(
				"\n\nemployee with id=21 & name='amy' removed: " + hashSetCustom.remove(new Person("21", "amy")));
		System.out
				.println("employee with id=51 & name='pat' removed: " + hashSetCustom.remove(new Person("51", "pat")));
